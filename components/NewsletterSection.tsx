...
export default function NewsletterSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!email) return
    // TODO: replace this URL with your email provider endpoint
    // ConvertKit: https://app.convertkit.com/forms/YOUR_FORM_ID/subscriptions
    // Mailchimp: use their embed action URL
    setSubmitted(true)
  }
      ...
      <div className="max-w-xl mx-auto text-center relative">
        ...
        <FadeIn delay={0.1}>
          <h2 className="font-serif text-3xl md:text-4xl text-charcoal mt-3 mb-2 leading-tight">
            free stuff for
            <br />
            <span className="font-script text-blush">lazy girls who sign up ♡</span>
          </h2>
        </FadeIn>

        <FadeIn delay={0.2}>
          <p className="font-sans text-taupe text-sm leading-relaxed max-w-sm mx-auto mb-8">
            get free prompts, first access to new systems, and lazy girl tips straight to your inbox.
            no spam. no overwhelm. just the good stuff.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          {submitted ? (
            ...
            >
              ...
              <p className="font-sans text-sm text-taupe">check your inbox for your free stuff.</p>
            </motion.div>
          ) : (
